let User,Joi;_6e1‍.x([["register",()=>register],["login",()=>login],["check",()=>check],["edit",()=>edit],["remove",()=>remove],["logout",()=>logout]]);_6e1‍.w("../../models/user",[["default",["User"],function(v){User=v}]]);_6e1‍.w("joi",[["default",["Joi"],function(v){Joi=v}]]);
...
// 회원가입
    ...
    if(result.error){
        _6e1‍.g.console.log(result.error);
        ctx.status = 400;
