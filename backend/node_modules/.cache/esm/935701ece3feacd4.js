let User,Joi;_e3f‍.x([["register",()=>register],["login",()=>login],["check",()=>check],["edit",()=>edit],["remove",()=>remove],["logout",()=>logout],["changePassword",()=>changePassword]]);_e3f‍.w("../../models/user",[["default",["User"],function(v){User=v}]]);_e3f‍.w("joi",[["default",["Joi"],function(v){Joi=v}]]);
...
// 회원가입
    ...
    if(result.error){
        _e3f‍.g.console.log(result.error);
        ctx.status = 400;
