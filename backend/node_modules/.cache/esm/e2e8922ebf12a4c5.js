let Like;_bf1‍.x([["addlike",()=>addlike],["cancelLike",()=>cancelLike],["likePeopleList",()=>likePeopleList]]);_bf1‍.w("../../models/likes",[["default",["Like"],function(v){Like=v}]]);
...
// 좋아요 누른 사람 리스트
       const likePeopleList = async (ctx) => {
